...
VariableArray=["acc","avgmldd0","maxmldd0","lowercircrhon2","siarea","namoc"]
VariableNames=["Anatrctic Circumpolar Current Strength/(Sv)","Average Mixed Layer Depth","Maximum Mixed Layer Depth","Lower Circulation Cell Strength","Sea Ice Area","Atlantic Meridional Overturning Circulation"]
...
for j in range(5,len(VariableArray)):
    unit_test=0
    plt.close()
