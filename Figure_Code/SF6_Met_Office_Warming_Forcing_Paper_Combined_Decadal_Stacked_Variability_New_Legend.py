...
TitleArray=["ACC std/Sv","Average MLD south of 50$^{\circ}$S std/m","Lower Circulation Strength std/(kg/s)"]
...
plt.savefig(save_location+"Forcing_Paper_Decadal_Warming_Stacked_NewLegend_Variability.pdf")
