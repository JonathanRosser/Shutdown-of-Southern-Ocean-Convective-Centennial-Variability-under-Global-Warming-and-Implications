...
do echo "${InstitutionArray[$i]} ${SourceArray[$i]} ${ExptArray[$i]} ${VariantArray[$i]}"
        ...
        then
                let model_memory_allocation=memory_allocation*16
                let model_time_allocation=time_allocation*16
        ...
        then
                let model_memory_allocation=memory_allocation*2
                let model_time_allocation=time_allocation*2
        elif [ ${SourceArray[$i]} =  "CNRM-ESM2-1" ]
        then
                let model_memory_allocation=memory_allocation*2
                let model_time_allocation=time_allocation*2
        ...
        overall_end_year=0
        for file in /badc/cmip6/data/CMIP6/CMIP/${InstitutionArray[$i]}/${SourceArray[$i]}/${ExptArray[$i]}/${VariantArray[$i]}/${file_table_id}/${file_var}/${GridArray[$i]}/latest/*.nc
        do
                echo "$file"
