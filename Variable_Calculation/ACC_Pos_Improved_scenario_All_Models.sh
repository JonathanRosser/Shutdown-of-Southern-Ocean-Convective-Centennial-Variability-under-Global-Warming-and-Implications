...
script_name="slurm_ACC_Pos_Improved_Calc.sh"
memory_allocation=50000
time_allocation=20
file_table_id="Omon"
file_var="msftbarot"
...
do echo "${InstitutionArray[$i]} ${SourceArray[$i]} ${ExptArray[$i]} ${VariantArray[$i]}"
        ...
        then
                let model_memory_allocation=memory_allocation*10
                let model_time_allocation=time_allocation*10
        else
        ...
        do
                ...
                sbatch  --mem=${model_memory_allocation} --time=${model_time_allocation}  --job-name="${script_name}_${SourceArray[$i]}_${j}_run" --output="${slurm_path}${script_name}_${SourceArray[$i]}_${VariantArray[$i]}_${j}.out"   --err="${slurm_path}${script_name}_${SourceArray[$i]}_${VariantArray[$i]}_${j}.err"  ${script_name} ${InstitutionArray[$i]} ${SourceArray[$i]} ${ExptArray[$i]} ${VariantArray[$i]} $j
        done
done
