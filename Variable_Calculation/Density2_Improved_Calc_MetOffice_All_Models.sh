...
GridArray=("gn" "gn" "gn" "gn" "gn" "gn" "gn" "gn" "gn" "gn" "gn" "gn")




script_name="slurm_Density2_Improved_Calc.sh"
...
do echo "${InstitutionArray[$i]} ${SourceArray[$i]} ${ExptArray[$i]} ${VariantArray[$i]}"
        ...
        overall_end_year=0
        for file in  /gws/nopw/j04/orchestra_vol1/jonros74/Met_Office_Runs/${SourceArray[$i]}/${ExptArray[$i]}/${VariantArray[$i]}/${file_table_id}/${file_var}/${GridArray[$i]}/embargoed/v20230619/*.nc
        do
                echo "$file"
